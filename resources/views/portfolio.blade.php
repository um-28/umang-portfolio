...
<head>
    ...
    <title>Patel Umang | Software Developer Portfolio</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top glass-nav">
        <div class="container">
            <a class="navbar-brand fw-bold text-light" href="#home">Umang.dev</a>
    ...
    <main class="container py-5 position-relative" id="home">
        <section class="hero card-3d p-4 p-md-5 mb-5 reveal">
            <div class="row align-items-center g-4">
                <div class="col-lg-7">
                    ...
                    <h1 class="display-5 fw-bold mb-2">Hi, I'm <span class="gradient-text">Patel Umang</span></h1>
                    <p class="mb-3 typed-line">I build <span id="typed-text">Laravel APIs</span></p>
                    <p class="lead text-light-emphasis mb-4">Laravel backend development, Flutter apps, API integrations, and modern 3D inspired front-end experiences.</p>
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <a class="btn btn-primary px-4" href="#projects">View Projects</a>
                        <a class="btn btn-outline-light px-4" href="#contact">Let's Connect</a>
                    </div>
        ...
        <section class="mb-5 reveal" id="skills">
            ...
            <div class="row g-3">
                ...
                <div class="col-sm-6 col-lg-4"><div class="skill-chip">JavaScript Animation</div></div>
                <div class="col-sm-6 col-lg-4"><div class="skill-chip">Flutter Cross-platform Apps</div></div>
                <div class="col-sm-6 col-lg-4"><div class="skill-chip">REST API + MySQL</div></div>
            </div>
        </section>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <article class="glass-card h-100">
                        <h3>CareMitra App</h3>
                        <p>Healthcare platform with appointments, patient profile flows, and secure Laravel APIs integrated with Flutter.</p>
                ...
                <div class="col-md-6">
                    <article class="glass-card h-100">
                        <h3>MarryMate App</h3>
                        <p>Wedding planning application with vendor booking, hall management, and availability APIs.</p>
                        <div class="tech-list"><span>Flutter</span><span>REST API</span><span>Bootstrap Admin</span></div>
                    </article>
                </div>
            </div>
        </section>

        <section id="experience" class="mb-5 reveal">
            <h2 class="section-title">Experience Highlights</h2>
            <div class="timeline">
                <div class="timeline-item">
                    <h4>Backend Developer</h4>
                    <p>Designed reusable auth, booking, and profile APIs with optimized database queries and validation patterns.</p>
                </div>
                <div class="timeline-item">
                    <h4>Flutter Developer</h4>
                    <p>Built smooth UI and scalable module-based architecture for production-grade Android applications.</p>
                </div>
            </div>
        </section>
